...
winning (case 4) or surrendering (case 5).  These five cases separate the space
of possible states with positive reward for miner 1 into disjoint sets, which
can be analyzed separately using combinatorial computations. After any of the
states discussed above, both players mine on the same block and therefore the
strategies advise similar actions as in the beginning of the game (this happens
because of the way these strategies are defined).  Thus, as in the case of
Theorem
