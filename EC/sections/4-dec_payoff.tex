...
\theta_{a,b}^r & = & 
 \begin{cases}
 {\displaystyle {r+b\choose b}} & \quad \text{If } r \leq a\\
 {\displaystyle \sigma_{|b-r|,\min(r,b)} + \sum_{i=\max(1,r-b+1)}^a  \sum_{j=0}^{r-i}\sigma_{i-1,j}\cdot \sigma_{i+b-r,r-i-j}} &  \quad \text{If } a<r\\
