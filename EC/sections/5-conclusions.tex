...
to be a difficult task. In particular, in the two player game one can show that the default strategy can never be part of such an 
equilibrium, no matter how small the hash power is for one of the players. This means that one must look for much more complex strategies to find such an equilibrium. 
