...
Recall that a block $b$ is a string over the alphabet $\bP = \{0,1\}$, and we use notation $|b|$ for the length of $b$ as a string. 
Then we define: 
\begin{eqnarray*}
...
In this paper we consider the following pay-off functions:
\begin{itemize}
