...
\end{tikzpicture} 
\end{center}
\caption{Although two paths are competing to become the blockchain, the blocks up to 1001 will contribute to the reward in each case. \label{fig-simple-fork}}
\end{figure}
...
%As mentioned before, miners are rewarding according to their
% function rewards a player for the 
