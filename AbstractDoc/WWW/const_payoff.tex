...
is defined as:
\begin{eqnarray*}
u_p(\cdf) & = & \sum_{q \in \bQ} \beta^{|q|-1} \cdot  r_p(q) \cdot \pr^{\cdf}(q).
\end{eqnarray*}
...
\begin{eqnarray*}
u_p(\cdf) & \geq & \sum_{q \in \sigma(q^*) \,:\, q^* \in Q_{\bs}} \beta^{|q|-1} \cdot  r_p(q) \cdot \pr^{\cdf}(q).
\end{eqnarray*}
...
\begin{eqnarray*}
u_p(\cdf) & \geq &\sum_{q^* \in Q_{\bs}}   \sum_{q \in \sigma(q^*)} \beta^{|q|-1} \cdot  r_p(q) \cdot \pr^{\cdf}(q).
\end{eqnarray*}
...
\begin{eqnarray*}
u_p(\cdf) & \geq & \sum_{q^* \in Q_\bs} \bigg(\beta^{|q^*|-1} \cdot  r_p(q^*) \sum_{q \in \sigma(q^*)}  \pr^{\cdf}(q)\bigg)\\
& = & \sum_{q^* \in Q_\bs} \beta^{|q^*|-1} \cdot  r_p(q^*) \cdot \pr^{\bs}(q^*)\\
& = & \sum_{q^* \in \bQ} \beta^{|q^*|-1} \cdot  r_p(q^*) \cdot \pr^{\bs}(q^*)\\
& = & u_p(\bs), 
\end{eqnarray*}
