...
\subsection{Transition probability function}\label{sub:transi}
...
\end{equation*} and with property \ref{prop:bound} ??
\etienne{Actually it is not immediate at all, too bad ;s can u have that ?}
\end{proof}
