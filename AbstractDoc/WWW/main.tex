...
discounts similar to those in Bitcoin, miners do have an incentive to fork; in fact, it is profitable to do so even when they own less than half of the network's hash power. 
\end{abstract}
...
Our model of mining via a stochastic game allows for an intuitive representation of miner's actions as strategies, 
...
Nash-equilibirum for any hash-power repartition. 
 %where miners can modify their strategy after each action. 
