...
\end{cases}
\end{eqnarray*}
where $c$ is a positive real number and $d \in \mathbb{N}$. 
...
The next step step is to describe different strategies that the players can use in the game. To this end, given a player $p \in \bP$ and a body of knowledge $q$,
