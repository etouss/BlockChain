...
Hence, miners looking to maximise their crypto-wealth are better of with the default strategy. Interestingly, previous work shows this may not be the case if 
we model the game and incentives for miners in a different way. For example, the default strategy is not optimal under a setting in which 
