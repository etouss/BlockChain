...
Since older blocks in the blockchain could have already been cashed-out, we ensure that the penalty for a block leaving the blockchain decreases over time. 
