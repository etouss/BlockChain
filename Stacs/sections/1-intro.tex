...
Moreover as our model offers a fair reward to each miner if a mining race occurs, it allow us to study the validity of the assumption that long fork are not an optimal strategy.
%  Besides,
...
provides the highest possible utility for all players. Therefore with constant reward, the commonly accepted assumption that long forks should not happen is true. 
