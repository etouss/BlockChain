...
This suggests that miner's behaviour can really deviate depending on what are their short and long term goals, and we believe this is an interesting direction for future work. Moreover the results obtained in previously mentioned previous work arguably represent more accurately the bitcoin's mining but rely on the assumption that long fork do not happen, our result prove the validity of such assumption in the case of constant rewards. 
